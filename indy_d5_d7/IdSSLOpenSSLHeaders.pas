...
var
  ...
  X509_Name_Oneline : function(a: PX509_NAME; buf: PChar; size: Integer):PChar cdecl = nil;
    //
...
Begin
  ...
  If @X509_get_serialNumber=nil Then result := result + ' ' + fn_X509_get_serialNumber;  {Do not localize}
...
//  If @IdSslUCTTimeDecode=nil Then result := result + ' ' + fn_UCTTimeDecode;  {Do not localize}
  ...
  If @d2i_X509=nil then result := result + ' ' + fn_d2i_X509;
  If @CRYPTO_free=nil then result := result + ' ' + fn_CRYPTO_Free;
  If @X509_free=nil then result := result + ' ' + fn_X509_Free;

  //BN
  If @BN_bn2dec=nil then result := result + ' ' + fn_BN_bn2dec; {Do not localize}
  IF @BN_free=nil then result := result + ' ' + fn_BN_free; {Do not localize}

  //ASN1
  If @ASN1_INTEGER_to_BN=nil then result := result + ' ' + fn_ASN1_INTEGER_to_BN; {Do not localize}
